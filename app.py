...
def generate_explanation_with_image(img_path, prediction, confidence):
    try:
        ...
        prompt = (
            ...
            f"Explain what melanoma cancer is and why it appeared "
            f"Please confirm and explain whether this classification makes sense based on the uploaded image. "
            f"Describe visible signs or features that align with {prediction} lesions in a clear with the rough measurement, medically-informed, readable format. "
